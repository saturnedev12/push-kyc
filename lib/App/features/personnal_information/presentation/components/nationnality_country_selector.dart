...
class NationnalityCountrySelector extends StatelessWidget {
  const NationnalityCountrySelector({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<KycDocCubit, KycDocState>(
      buildWhen:
          (prev, curr) =>
              prev.nationalityCountryCode != curr.nationalityCountryCode,
        ...
        return SliverPadding(
          ...
          sliver: SliverToBoxAdapter(
            child: ListTile(
              onTap: () {
                showCountryPicker(
                  ...
                  onSelect: (Country country) {
                    context.read<KycDocCubit>().setNationalityCountryCode(
                      country.countryCode,
                    );
              ...
              leading:
                  (state.nationalityCountryCode == null)
                      ? FaIcon(
